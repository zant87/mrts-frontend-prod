      ...
      <MDBCol lg="6" className="chart mt-10" style={{ marginBottom: "10px" }}>
        ...
        <MDBTabContent className="card" activeItem={this.state.activeItemJustified}>
          <MDBTabPane tabId="1" role="tabpanel">
            <IndsChart indVals={this.props.indVals} isFetchingIndData={this.props.isFetchingIndData} frequencyId={this.props.frequencyId} />
          </MDBTabPane>
          <MDBTabPane tabId="2" role="tabpanel">
            <IndsTable indVals={this.props.indVals} isFetchingIndData={this.props.isFetchingIndData} frequencyId={this.props.frequencyId} />
          </MDBTabPane>
        </MDBTabContent>
      </MDBCol>
    );
