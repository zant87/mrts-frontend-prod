...
import dyn from "./DynSettings.module.css";
//import "./DynSettings.module.css";
import { render } from "react-dom";

class DynSettings extends React.Component {
  ...
  onSelectFrequency = (e) => {
    let frequencyDynId = e.target.value;
    this.props.setFrequencyId(frequencyDynId);
  };
  ...
  onSaveFilters = () => {
    let frequencyDynId = this.selectedFrequencyIdRef.current.value;
            ...
            <form className="needs-validation" onSubmit={this.submitHandler}>
              ...
              <div className="form-group">
                ...
                >
                  {this.props.frequencies
                    ? this.props.frequencies.map((item) =>
                        this.props.frequencyDynId == item.id ? (
                          <option value={item.id} selected>
                            {item.name}
                          </option>
                        ) : (
