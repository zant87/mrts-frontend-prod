...
import { MDBBtn, MDBContainer, MDBInput, MDBRow, toast } from "mdbreact";
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <MDBRow center>
              <FormControl fullWidth={true} className="mx-auto">
                <Controller as={<TextField disabled />} name="id" label="#" control={control} defaultValue={props.data ? props.data.id : ""} />
                <Controller
                  as={<MDBInput disabled className="mt-3" />}
                  name="indicatorName"
                  label="Наименование"
                  control={control}
                ...
                />
                <Controller
                  as={<MDBInput disabled type="textarea" rows="2" className="mt-3" />}
                  name="scenarioName"
                  label="Сценарий"
                  control={control}
