...
export default class OperatorPlanResourcesEditPage extends React.Component {
  ...
  constructor(props) {
    ...
    this.state.transportStrategyCode = props.data.transportStrategyName;
    ...
    return (
      <MDBContainer>
        <div className="scrollbar my-1 mx-auto" style={{ minHeight: "600px", maxHeight: "600px" }}>
          ...
          <MDBInput
            label="Минимальное ресурсное обеспечение, млрд. руб."
            value={this.state.planingMin}
            type="number"
            name="planingMin"
            onChange={(e) => this.onChangeHandler(e)}
          />
          <MDBInput
            label="Максимальное ресурсное обеспечение, млрд. руб."
            value={this.state.planingMax}
            name="planingMax"
            type="number"
            onChange={(e) => this.onChangeHandler(e)}
          />
