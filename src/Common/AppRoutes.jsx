...
export const AppRoutes = () => {
    return (
        <Fragment>
            ...
            <PrivateRoute exact path="/admin/structure/IndicatorScheme" roles={Role.Admin}
                          component={AdminStructureIndicatorsScheme}/>
            ...
            <PrivateRoute exact path="/admin/loading/fromEMISS" roles={Role.Admin}
                          component={AsyncAdminLoadingFromEMISSPage}/>
            <PrivateRoute exact path="/admin/loading/fromMDD" roles={Role.Admin}
                          component={AsyncAdminLoadingFromMDDPage}/>
            <PrivateRoute exact path="/admin/loading/fromMSTK" roles={Role.Admin}
                          component={AsyncAdminLoadingFromMSTKPage}/>
            <PrivateRoute exact path="/admin/loading/fromSDMX" roles={Role.Admin}
                          component={AsyncAdminLoadingFromSDMXPage}/>
            ...
            <PrivateRoute exact path="/admin/loading/resourcesFromXLSX" roles={Role.Admin}
                          component={AdminLoadingResourcesFromXLSXPage}/>
            <PrivateRoute exact path="/admin/loading/activitiesFromXLSX" roles={Role.Admin}
                          component={AdminLoadingActivitiesFromXLSXPage}/>
            <PrivateRoute exact path="/admin/loading/formulas" roles={Role.Admin}
                          component={AdminLoadingFormulasPage}/>
            {/*AdminLoadingDocumentPage*/}

            {/*Archive - Архив */}
            <PrivateRoute exact path="/admin/archive/parameters" roles={Role.Admin}
                          component={AdminArchiveParametersPage}/>
            <PrivateRoute exact path="/admin/archive/indicators" roles={Role.Admin}
                          component={AdminArchiveIndicatorsPage}/>
            <PrivateRoute exact path="/admin/archive/activities" roles={Role.Admin}
                          component={AdminArchiveActivitiesPage}/>
            ...
            <PrivateRoute exact path="/operator/plan/activities" roles={Role.Operator}
                          component={AsyncOperatorPlanActivitiesPage}/>
            <PrivateRoute exact path="/operator/plan/projects" roles={Role.Operator}
                          component={AsyncOperatorPlanProjectsPage}/>
            <PrivateRoute exact path="/operator/plan/indicators" roles={Role.Operator}
                          component={AsyncOperatorPlanIndicatorsPage}/>
            <PrivateRoute exact path="/operator/plan/resources" roles={Role.Operator}
                          component={AsyncOperatorPlanResourcesPage}/>
            <PrivateRoute exact path="/operator/plan/resources/:id" roles={Role.Operator}
                          component={AsyncOperatorPlanResourcesEditPage}/>
            <PrivateRoute exact path="/operator/plan/indicators/:id" roles={Role.Operator}
                          component={AsyncOperatorPlanIndicatorsEditPage}/>
