          ...
          <React.Fragment>
            ...
            >
              <li>
                <ul className="social">
                  <li>
                    <p className="custom-font">Информационно-Аналитическая Система Регулирования На Транспорте</p>
                  </li>
                </ul>
              </li>
              ...
              <MDBNavbarNav right style={specialCaseNavbarStyles}>
                <MDBNavItem>
                  <MDBTooltip material placement="bottom" clickable>
                    <MDBNavLink to="#">
                      <MDBIcon icon="user" /> {/*<div className="d-none d-xl-inline">{fullname}</div>*/}
                    </MDBNavLink>
                    <span>
                ...
                <MDBNavItem>
                  <MDBTooltip material placement="bottom" clickable>
                    <MDBNavLink to="#">
                      <MDBIcon icon="headphones-alt" /> {/*<div className="d-none d-xl-inline">Поддержка, +7 (495) 380-21-53</div>*/}
                    </MDBNavLink>
                    <span>
                      <em>Поддержка</em>
                      <br />
            ...
            <main style={mainStyle}>
              <MDBContainer fluid className="mt-1 mb-5">
                <ToastContainer position="top-right" autoClose={3000} closeButton={false} newestOnTop={false} className="mr-4" rtl={false} />
                <AppRoutes />
              </MDBContainer>
            </main>
            {currentUser && <Footer />}
