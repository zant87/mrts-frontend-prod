...
class App extends React.Component {
    ...
    componentDidMount() {
        console.log('[App.js] componentDidMount returned user =', authenticationService.currentUser);

        authenticationService.currentUser.subscribe((x) => {

                authenticationService.logUser(x);
    ...
    render() {
        ...
        let exitLinks =
            <MDBNavItem>
                <a className="nav-link" href="https://mrts.asutk.ru/logout">
                      ...
                      <b>+7 (495) 380-21-53</b>
                                ...
                                {isAdmin && (
                                    <React.Fragment>
                                        ...
                                        <MDBNavItem>
                                            <a className="nav-link"
                                               onClick={(e) => this.setLayout(Layouts.adminControl)}>
                                                Контроль
                                            </a>
                                        </MDBNavItem>
                                        <MDBNavItem>
                                            <a className="nav-link"
                                               onClick={(e) => this.setLayout(Layouts.adminLoading)}>
                                                Загрузка
                                            </a>
                                        </MDBNavItem>
                                        <MDBNavItem>
                                            <a className="nav-link"
                                               onClick={(e) => this.setLayout(Layouts.adminArchive)}>
                                                Архив
                                            </a>
                                        </MDBNavItem>
                                    </React.Fragment>
                                ...
                                {isOperator && (
                                    <React.Fragment>
                                        <MDBNavItem>
                                            <a className="nav-link"
                                               onClick={(e) => this.setLayout(Layouts.operatorPlan)}>
                                                План
                                            </a>
                                        </MDBNavItem>
                                        <MDBNavItem>
